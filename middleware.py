...
class Middleware:
    def __init__(self, app, **kwargs):
        ...
        self.allow_all_origins = kwargs.get('allow_all_origins') or False
    ...
    def __call__(self, environ, start_response):
        ...
        def add_cors_headers(status, headers, exc_info=None):
            ...
            if environ.get('HTTP_ORIGIN') and (self.allow_all_origins or environ['HTTP_ORIGIN'] in self.cors_origins):
